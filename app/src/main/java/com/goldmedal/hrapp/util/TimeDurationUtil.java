...
public class TimeDurationUtil {
     ...
     */
    public static String formatHoursMinutes(long duration) {
        return    hoursOf(duration)+" H "+ minutesInHourOf(duration)+" M ";
//        return String.format("%d:%02d:%02d", hoursOf(duration)+"Hr", minutesInHourOf(duration));
    }
    public static String formatHoursMinutesSeconds(long duration) {
        return String.format(Locale.getDefault(),"%02d:%02d:%02d", hoursOf(duration), minutesInHourOf(duration),secondsInMinuteOf(duration));
//        return String.format("%d:%02d:%02d", hoursOf(duration)+"Hr", minutesInHourOf(duration));
    }
    /**
    ...
    public static String formatDuration(long duration) {
        return String.format(Locale.getDefault(),"%02d:%02d", hoursOf(duration), minutesInHourOf(duration));
//        return String.format("%d:%02d:%02d", hoursOf(duration)+"Hr", minutesInHourOf(duration));
    }
    /**
