package com.goldmedal.hrapp.inappupdates;
...
import static com.goldmedal.hrapp.inappupdates.UpdateManagerConstant.FLEXIBLE;
...
public class UpdateManager implements LifecycleObserver {
            ...
            public void onSuccess(AppUpdateInfo appUpdateInfo) {
                if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                    ...
                    if (flexibleUpdateDownloadListener != null) {
                        flexibleUpdateDownloadListener.onReceiveAppUpdate();
                    }

                    Log.d(TAG, "No Update available : checkUpdate");
                }
            }
        });
    }
    ...
    private void startUpdate(AppUpdateInfo appUpdateInfo) {
        try {
            ...
            //Error Occured Fallback to check version code manually
            if (flexibleUpdateDownloadListener != null) {
                flexibleUpdateDownloadListener.onReceiveAppUpdate();
            }
            Log.d(TAG, "error in startUpdate " + mode + " : " + e);
        }
                    ...
                    public void onSuccess(AppUpdateInfo appUpdateInfo) {
                        if (appUpdateInfo.updateAvailability()
                            ...
                            try {
                                ...
                                Log.d(TAG, "in continueUpdateForImmediate " + instance.mode + " : " + e.getMessage());
        ...
        appUpdateInfoTask.addOnSuccessListener(new OnSuccessListener<AppUpdateInfo>() {
            ...
            public void onSuccess(AppUpdateInfo appUpdateInfo) {
                if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE) {
                    ...
                    Log.d(TAG, "No Update available : addUpdateInfoListener");
                }
            }
        });
    }
